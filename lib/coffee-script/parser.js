...
case 4:this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])((function () {
        var i, _i;
        if ((typeof $$[$0-1] !== "undefined" && $$[$0-1] !== null) && $$[$0-1] > 1) {
          for (i = _i = 1; 1 <= $$[$0-1] ? _i < $$[$0-1] : _i > $$[$0-1]; i = 1 <= $$[$0-1] ? ++_i : --_i) {
            $$[$0-2].push(new yy.Newline);
          }
        }
        $$[$0-2].push($$[$0]);
        return $$[$0-2];
...
case 5:this.$ = yy.addLocationDataFn(_$[$0-1], _$[$0])((function () {
        var i, _i;
        if ((typeof $$[$0] !== "undefined" && $$[$0] !== null) && $$[$0] > 1) {
          for (i = _i = 1; 1 <= $$[$0] ? _i < $$[$0] : _i > $$[$0]; i = 1 <= $$[$0] ? ++_i : --_i) {
            $$[$0-1].push(new yy.Newline);
          }
        }
        return $$[$0-1];
      }()));
