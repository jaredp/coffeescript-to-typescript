...
(function() {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var answer, assign, assign_index, decl, fn, isStatic, members, name, node, vname, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        param = _ref4[_i];
        console.log(this.fnName.constructor.name, this.fnName);
