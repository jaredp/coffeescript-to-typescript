...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, atProperty, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, sendSyntaxWarning, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  _ref1 = require('./helpers'), compact = _ref1.compact, flatten = _ref1.flatten, extend = _ref1.extend, merge = _ref1.merge, del = _ref1.del, starts = _ref1.starts, ends = _ref1.ends, last = _ref1.last, some = _ref1.some, addLocationDataFn = _ref1.addLocationDataFn, locationDataToString = _ref1.locationDataToString, throwSyntaxError = _ref1.throwSyntaxError, sendSyntaxWarning = _ref1.sendSyntaxWarning;
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.isNamed = function(name) {
      return !this.hasProperties() && this.base.value === name;
    };
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var answer, assign, assign_index, decl, fn, methodName, name, node, node_index, value, varname, _i, _j, _len, _len1, _ref4, _ref5;
      decl = this.determineName();
      name = decl || '_Class';
      if (name.reserved) {
        name = "_" + name;
      }
      answer = flatten([this.makeCode("class " + name), this.parent ? [this.makeCode(" extends "), this.parent.compileToFragments(o)] : [], this.makeCode(" {\n")]);
      this.body.spaced = true;
      o.indent += TAB;
      _ref4 = this.body.expressions.slice(0);
      for (node_index = _i = 0, _len = _ref4.length; _i < _len; node_index = ++_i) {
        node = _ref4[node_index];
        if (node instanceof Assign && node.variable.base.value === "this" && node.variable.properties.length === 1) {
          ...
          if (value instanceof Code) {
            ...
            answer = answer.concat(flatten([this.makeCode((node_index !== 0 ? "\n\n" : '')), this.makeCode("" + o.indent + "static "), value.compileToFragments(o)]));
          } else {
            answer = answer.concat(flatten([this.makeCode((node_index !== 0 ? "\n\n" : '')), this.makeCode("" + o.indent + "static "), varname.compileToFragments(o), this.makeCode(" = "), value.compileToFragments(o), this.makeCode(";")]));
          }
        } else if (node instanceof Value && node.base instanceof Object) {
          _ref5 = node.base.properties;
          for (assign_index = _j = 0, _len1 = _ref5.length; _j < _len1; assign_index = ++_j) {
            assign = _ref5[assign_index];
            if (!(assign instanceof Assign) || assign.context !== 'object' || assign.variable.properties.length !== 0) {
              assign.warn("not sure what this is; not generating");
              continue;
            }
            methodName = assign.variable;
            fn = assign.value;
            if (!(fn instanceof Code)) {
              assign.warn("not sure what this is; not generating");
              continue;
            }
            fn.isMethod = true;
            fn.fnName = methodName;
            answer = answer.concat(flatten([this.makeCode((node_index !== 0 || assign_index !== 0 ? "\n\n" : '')), this.makeCode("" + o.indent), fn.compileToFragments(o)]));
          }
        } else {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (this.value instanceof Code && !this.variable.isComplex()) {
        if (match = METHOD_DEF.exec(name)) {
          if (match[1]) {
            this.value.klass = match[1];
          }
          this.value.name = (_ref5 = (_ref6 = (_ref7 = match[2]) != null ? _ref7 : match[3]) != null ? _ref6 : match[4]) != null ? _ref5 : match[5];
        }
        this.value.fnName = this.variable;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, exprs, idt, jsParam, member, param, params, ref, uniqs, val, wasEmpty, _i, _len, _ref4, _ref5, _ref6;
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        param = _ref4[_i];
        if ((member = atProperty(param.name)) && this.fnName.isNamed('constructor')) {
        ...
        params.push(flatten([param.splat ? this.makeCode('...') : [], jsParam, param.value ? [this.makeCode(" = "), param.value.compileNode(o)] : []]));
      ...
      idt = o.indent;
      answer = flatten([this.isMethod == null ? this.makeCode('function') : [], (this.fnName != null) && !this.isMethod ? this.makeCode(' ') : [], this.fnName != null ? this.fnName.compileNode(o) : [], this.makeCode('('), this.joinFragmentArrays(params, ', '), this.makeCode(') {'), !this.body.isEmpty() ? [this.makeCode("\n"), this.body.compileWithDeclarations(o), this.makeCode("\n" + this.tab)] : [], this.makeCode('}')]);
