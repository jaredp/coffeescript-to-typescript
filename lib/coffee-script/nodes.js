...
(function() {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var addMember, answer, assign, assign_index, decl, fn, isStatic, members, name, node, vname, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5,
        _this = this;
      ...
      o.indent += TAB;
      members = [];
      addMember = function(assign) {
        members.push(assign);
        if (assign instanceof Comment) {
          return;
        }
        if (assign.variable.isNamed("constructor")) {
          _this.ctor = assign.value;
        }
        if (assign.value instanceof Code && assign.value.bound) {
          _this.boundFuncs.push(assign.variable);
          return assign.value.bound = false;
        }
      };
      _ref4 = this.body.expressions;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        node = _ref4[_i];
      ...
      this.addBoundFunctions();
      for (assign_index = _k = 0, _len2 = members.length; _k < _len2; assign_index = ++_k) {
        assign = members[assign_index];
        if (assign_index !== 0) {
          answer.push(this.makeCode("\n\n"));
        }
        if (assign instanceof Comment) {
          answer.push.apply(answer, assign.compileToFragments(o));
          continue;
        }
        ...
        if ((fn = assign.value) instanceof Code) {
          ...
          fn["static"] = isStatic;
          fn.fnName = vname;
          answer = answer.concat(flatten([this.makeCode("" + o.indent + (isStatic ? "static " : "")), fn.compileToFragments(o)]));
        } else {
          answer = answer.concat(flatten([this.makeCode("" + o.indent + (isStatic ? "static " : "public ")), vname.compileToFragments(o), this.makeCode(" = "), assign.value.compileToFragments(o), this.makeCode(";")]));
        }
      }
      answer.push(this.makeCode("\n}"));
      return answer;
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (this.value instanceof Code && (this.value.fnName = this.variable.vanillaName())) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        param = _ref4[_i];
        if ((member = atProperty(param.name)) && this.fnName.value === 'constructor') {
