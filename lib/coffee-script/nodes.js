...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, sendSyntaxWarning, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, exprs, idt, p, param, params, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _len, _len1, _len2, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        ...
        if (param.isComplex()) {
          ...
          params.push(flatten([param.splat ? this.makeCode('...') : [], param.name.compileNode(o), param.value ? [this.makeCode(" = "), param.value.compileNode(o)] : []]));
        }
