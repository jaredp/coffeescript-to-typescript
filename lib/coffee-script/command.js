...
(function() {
  var BANNER, CoffeeScript, EventEmitter, FakeBlock, SWITCHES, compileJoin, compileOptions, compilePath, compileScript, compileStdio, exec, exists, failedFiles, fileFinished, forkNode, fs, helpers, hidden, joinTimeout, notSources, onCompilationFinished, optionParser, optparse, opts, outputPath, parseOptions, path, printLine, printTokens, printWarn, reAddComments, removeSource, runningFiles, setRunningFiles, setTranslatingFile, sourceCode, sources, spawn, timeLog, unwatchDir, usage, useWinPathSep, version, wait, watch, watchDir, watchers, writeJs, _ref;
