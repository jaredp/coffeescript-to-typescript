...
(function() {
  var Lexer, Module, SourceMap, child_process, compile, compileFile, ext, extensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, loadFile, parser, path, setTranslatingFile, sourceMaps, vm, _i, _len,
  ...
  exports.compile = compile = function(code, options) {
    var answer, currentColumn, currentLine, foundNonFragment, fragment, fragments, header, js, map, merge, newLines, _i, _j, _len, _len1;
    if (options == null) {
      options = {};
    }
    merge = helpers.merge;
