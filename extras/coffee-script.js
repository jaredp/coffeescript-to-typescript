...
var exports = {}, module = {exports: exports};  var Lexer, Module, SourceMap, child_process, compile, compileFile, ext, extensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, loadFile, parser, path, setTranslatingFile, sourceMaps, toSAST, vm, _i, _len,
  ...
  exports.compile = compile = function(code, options) {
    var answer, ast, currentColumn, currentLine, foundNonFragment, fragment, fragments, header, js, lexemes, map, merge, newLines, sast, _i, _j, _len, _len1;
    if (options == null) {
      options = {};
    }
    merge = helpers.merge;
  ...
  compileFile = function(filename, sourceMap) {
    ...
    try {
      ...
      err.code = stripped;
      helpers.prettyErrorMessage(error, filename, stripped, true);
      answer = "";
    }
    return answer;
  };
...
//# sourceMappingURL=coffee-script.map
